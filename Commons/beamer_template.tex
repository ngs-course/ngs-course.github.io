...
\def \titulolargo {$title$}         % long title:  this will go to the FIRST slide.
\def \titulocorto {$footer-right$}  % short title: this will go to the FOOTER of the slides.
\def \subtitulo {$subtitle$}
\def \autorlargo {$author$}         % long author:  this will go to the FIRST slide.
\def \autorcorto {$footer-left$}    % short author: this will go to the FOOTER of the slides.
\def \fecha {$date$}
\def \pagina {$url$}
...
%%   \includegraphics{images/big}
%% \end{frame}

%% \begin{frame}
%%   \frametitle{Images: small}
%%   \includegraphics{images/small}
%% \end{frame}
